...
import CopyFrom from '../components/copyForm';
												...
												<div>
													...
													<div className="avatar">
														<div className="elipse2">
															<img src={getProfilePic(store.members[index].id)} />
														</div>
													</div>
													<div className="name">
							...
							<div className="tickets">
									...
									<div className="winners_">
										<div className="avatar-win">
											<div className="elipse4">
												<img src={getProfilePic(store.winners[0].id)} />
											</div>
										</div>
								...
								{store.winners[1] && store.winners[0].time === store.winners[1].time ? (
									<div className="winners_">
										<div className="avatar-win">
											<div className="elipse4">
												<img src={getProfilePic(store.winners[1].id)} />
											</div>
										</div>
										<div className="avatar-title">
											<p className="p11">{store.winners[0].name}</p>
